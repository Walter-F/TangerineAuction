...
namespace TangerineAuction.Components
{
    public partial class RoundButton : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (var brush = new LinearGradientBrush(ClientRectangle, Color.FromArgb(255, 255, 236, 210), Color.FromArgb(255, 252, 182, 159), LinearGradientMode.Vertical))
